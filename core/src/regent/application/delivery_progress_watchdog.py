...
_STALE_NUDGE_MINUTES = 15
_STALE_NUDGE_COOLDOWN_MINUTES = 15
_STALE_MAX_NUDGES = 4
    ...
    *,
    ...
    async with sessions() as session, session.begin():
        ...
        for goal in goals:
            ...
            # 5–15 min: warn via live_action without creating a task.
